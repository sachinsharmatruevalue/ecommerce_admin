...
import BannerUpdate from './updateBanner';
                  ...
                  <tr key={index}>
                    ...
                    <td>
                      <div className="product-img">
                        <img src={process.env.REACT_APP_URL + banner?.image} alt="" style={{ height: '70px', width: '70px', objectFit: 'contain' }} />
                      </div>
                    </td>
                    <td>{truncateText(banner?.title, 15)}</td>
                    <td>{formatDateTime(banner?.createdAt)}</td>
                    <td className="status-toggle">
                      <HelpTogal data={banner} page='Banner' onSuccess={() => run()} />
                    </td>
                    <td><button className="btn btn-warning btn-sm content-icon me-1" onClick={() => handleEditDetails(banner)}><i className="fa fa-edit"></i></button></td>
                    <td><button className="btn btn-danger btn-sm content-icon ms-1" onClick={() => handleDelete(banner)}><i className="fa fa-times"></i></button></td>
