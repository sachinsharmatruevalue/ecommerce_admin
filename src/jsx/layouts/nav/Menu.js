    ...
    // user manager 
     {
        title: 'User Manager',
        classsChange: 'mm-collapse',		
        iconStyle: <i className="fa-solid fa-user"></i>,
         to: 'admin/users',
        },
        {
            title: 'Contact',
            classsChange: 'mm-collapse',		
            iconStyle: <i className="fa-solid fa-address-book"></i>,
             to: 'admin/contact',
            },
        {
            title: 'Pages',	
        ...
        },
        {
            title: 'Notification',
            classsChange: 'mm-collapse',		
            iconStyle: <i className="far fa-bell"></i>,
            ...
            },  
            {
                title: 'Blog',
                classsChange: 'mm-collapse',		
                iconStyle: <i className="far fa-newspaper"></i>,
                 to: 'admin/blogs',
                ...
                },  
                {
                    title: 'Banner',
                    classsChange: 'mm-collapse',		
                    iconStyle: <i className="fas fa-image"></i>,
                     to: 'admin/banner',
